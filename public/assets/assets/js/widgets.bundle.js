        ...
        t = function (e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    n = {
                        series: [
                            { name: "User Registration", data: [65, 80, 80, 60, 60, 45, 45, 80, 80, 70, 70, 90, 90, 80, 80, 80, 60, 60, 50] },
                            { name: "User Enquiries", data: [90, 110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 115, 95, 95, 85, 85] },
                        ],
                        chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } },
                        plotOptions: {},
                        legend: { show: !1 },
                        ...
                        xaxis: {
                            categories: ["", "8", "81", "9 Jan 2021", "10", "11", "12", "13", "14", "15 Jan 2021", "16", "17", "18", "18:20", "18:20", "30 Jan 2021", "20", "21", ""],
                            axisBorder: { show: !1 },
                            axisTicks: { show: !1 },
                            tickAmount: 6,
                            labels: { rotate: 0, rotateAlways: !0, style: { colors: l, fontSize: "12px" } },
                            crosshairs: { position: "front", stroke: { color: [o, s], width: 1, dashArray: 5 } },
                            tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } },
                        },
...
//    =====
var KTChartsWidget0107 = (function () {
    var e = { self: null, rendered: !1 },
        t = function (e) {
            var t = document.getElementById("kt_charts_widget_0107");
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--kt-gray-500"),
                    r = KTUtil.getCssVariableValue("--kt-border-dashed-color"),
                    ...
                    n = {
                        series: [
                            { name: "Report 1", data: [65, 80, 80, 60, 60, 45, 45, 80, 80, 70, 70, 90, 90, 80, 80, 80, 60, 60, 50] },
                            { name: "Report 2", data: [90, 110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 115, 95, 95, 85, 85] },
                        ],
                        chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } },
                        plotOptions: {},
                        legend: { show: !1 },
...
"undefined" != typeof module && (module.exports = KTChartsWidget0107),
    KTUtil.onDOMContentLoaded(function () {
        KTChartsWidget0107.init();
    });
...
var KTChartsWidget9 = {
    init: function () {
        !(function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    a = KTUtil.getCssVariableValue("--kt-gray-400"),
                    l = KTUtil.getCssVariableValue("--kt-border-dashed-color"),
                    ...
                    i = {
                        ...
                        colors: [r, o],
                        grid: { borderColor: l, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                        markers: { colors: [r, o], strokeColor: [KTUtil.getCssVariableValue("--kt-primary"), KTUtil.getCssVariableValue("--kt-gray-300")], strokeWidth: 3 },
                    },
                    s = new ApexCharts(e, i);
                setTimeout(function () {
                    s.render();
                }, 200);
            }
...
var KTTablesWidget16 = (function () {
    ...
    return {
        init: function () {
            ...
            var D = [7, 5, 23, 12, 21, 9, 17, 15, 4, 24, 9, 17, 21, 7];
            b(f, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_2", D, !1);
            var z = [8, 10, 14, 21, 6, 31, 8, 23, 5, 3, 14, 7, 21, 12];
            b(u, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_3", z, !1);
            ...
            b(v, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, !1),
                KTThemeMode.on("kt.thememode.change", function () {
                    e.rendered && e.self.destroy(),
                        ...
                        b(f, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_2", D, f.rendered),
                        b(u, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_3", z, u.rendered),
