    ...
    init: function () {
        ...
        !(function () {
            ...
            function o(e, t, a) {
                var o = "",
                    r = "";
                t - e < 100 || "Today" == a ? ((o = "Today:"), (r = e.format("MMM D"))) : "Yesterday" == a ? ((o = "Yesterday:"), (r = e.format("MMM D"))) : (r = e.format("MMM D") + " - " + t.format("MMM D")),
            ...
            [].slice.call(t).map(function (e) {
                ...
                if (e) {
                    ...
                    new ApexCharts(e, {
                        ...
                        colors: [r],
                        markers: { colors: [r], strokeColor: [s], strokeWidth: 3 },
                    }).render();
                }
            }),
            (function () {
                    ...
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                s = {
                                    series: [
                                        { name: "Report 1", data: [44, 55, 57, 56, 61, 58] },
                                        { name: "Report 2", data: [76, 85, 101, 98, 87, 105] },
                                    ],
                                    ...
                                    xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: o, fontSize: "12px" } } },
                    ...
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            ...
                            var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                                ...
                                s = {
                                    series: [{ name: "Stock", data: [30, 40, 40, 90, 90, 70, 70] }],
...
//                    =====
            (function () {
                var e = document.getElementById("kt_charts_widget_52_chart");
                if (e) {
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            parseInt(KTUtil.css(e, "height"));
                            var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                                ...
                                r = KTUtil.getCssVariableValue("--kt-info"),
                                s = {
                                    series: [{ name: "Lead", data: [30, 40, 40, 90, 90, 70, 70] }],
                                    chart: { fontFamily: "inherit", type: "area", height: 350, toolbar: { show: !1 } },
                                    plotOptions: {},
                                    legend: { show: !1 },
                                    dataLabels: { enabled: !1 },
                    ...
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            ...
                            var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                                ...
                                s = KTUtil.getCssVariableValue("--ck-color-text"),
                                l = KTUtil.getCssVariableValue("--kt-warning"),
                                i = KTUtil.getCssVariableValue("--kt-warning-light"),
                                n = {
                                    series: [
                                        { name: "Tax Planning", data: [60, 50, 80, 40, 100, 60] },
                                        { name: "Mutual Funds", data: [70, 60, 110, 40, 50, 70] },
                                        { name: "Stocks", data: [20, 30, 50, 60, 50, 30] },
                                    ],
                                    chart: { fontFamily: "inherit", type: "area", height: 350, toolbar: { show: !1 } },
                                    plotOptions: {},
                                    legend: { show: !1 },
...
//                    =====
                        ...
                        a = function () {
                            ...
                            var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                                ...
                                r = {
                                    ...
                                    plotOptions: { bar: { horizontal: !1, columnWidth: ["12%"], borderRadius: [6, 6] } },
                                    legend: { show: !1 },
                                    dataLabels: { enabled: !1 },
                                    stroke: { show: !0, width: 2, colors: ["transparent"] },
                        ...
                        a = function () {
                            ...
                            var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                                ...
                                l = {
                                    ...
                                    grid: { borderColor: o, strokeDashArray: 4, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: 0 } },
                                };
                        ...
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                h = {
                                    ...
                                    chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
                                    plotOptions: {},
                                    legend: { show: !1 },
                                    dataLabels: { enabled: !1 },
                                    fill: { type: "solid", opacity: 1 },
                                    stroke: { curve: "smooth", show: !0, width: 2, colors: [l, "transparent", "transparent"] },
                                    xaxis: {
                                        categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"],
                                        axisBorder: { show: !1 },
                                        axisTicks: { show: !1 },
                                    ...
                                    colors: [l, n, c],
                                    grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                                    markers: { colors: [i, d, KTUtil.getCssVariableValue("--kt-primary-light")], strokeColor: [l, n, c], strokeWidth: 3 },
                                };
                        ...
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                h = {
                                    ...
                                    dataLabels: { enabled: !1 },
                                    fill: { type: "solid", opacity: 1 },
                                    stroke: { curve: "smooth", show: !0, width: 2, colors: [l, n, c] },
                                    xaxis: {
                                        x: 0,
                                        offsetX: 0,
                                        offsetY: 0,
                                    ...
                                    grid: { borderColor: r, strokeDashArray: 4, padding: { top: 0, bottom: 0, left: 0, right: 0 } },
                                    markers: { colors: [l, n, c], strokeColor: [l, n, c], strokeWidth: 3 },
                                };
                            (t.self = new ApexCharts(e, h)), t.self.render(), (t.rendered = !0);
                        };
                    a(),
                ...
                [].slice.call(e).map(function (e) {
                    ...
                    if (e) {
                        ...
                        new ApexCharts(e, {
                            ...
                            colors: [l],
                            markers: { colors: [l], strokeColor: [s], strokeWidth: 3 },
                        }).render();
                    }
                });
            })(),
                        ...
                        new ApexCharts(e, {
                            ...
                            plotOptions: {
                                radialBar: {
                                    ...
                                    track: { background: r, strokeWidth: "100%" },
                                },
                            },
                            colors: [o],
                ...
                [].slice.call(e).map(function (e) {
                    ...
                    if (e) {
                        ...
                        new ApexCharts(e, {
                            ...
                            dataLabels: { enabled: !1 },
                            fill: { type: "solid", opacity: 1 },
                            fill1: { type: "gradient", opacity: 1, gradient: { type: "vertical", shadeIntensity: 0.5, gradientToColors: void 0, inverseColors: !0, opacityFrom: 1, opacityTo: 0.375, stops: [25, 50, 100], colorStops: [] } },
                            stroke: { curve: "smooth", show: !0, width: 3, colors: [s] },
                            xaxis: {
                                categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"],
                                axisBorder: { show: !1 },
                ...
                [].slice.call(o).map(function (o) {
                    (e = o.getAttribute("data-kt-color")),
                        ...
                        new ApexCharts(o, {
                            ...
                            dataLabels: { enabled: !1 },
                            stroke: { show: !0, width: 2, colors: ["transparent"] },
                            xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: r, fontSize: "12px" } } },
                            ...
                            colors: [a, l],
                            grid: { padding: { top: 10 }, borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                        }).render();
                });
            })(),
            (function () {
                    ...
                    var a = {
                        ...
                        plotOptions: {
                            radialBar: {
                                ...
                                dataLabels: {
                                    showOn: "always",
                                    name: { show: !0, fontSize: "13px", fontWeight: "700", offsetY: -5, color: KTUtil.getCssVariableValue("--kt-gray-500") },
                                    value: { color: KTUtil.getCssVariableValue("--kt-gray-700"), fontSize: "30px", fontWeight: "700", offsetY: -40, show: !0 },
                                },
                            ...
                            o = {
                                ...
                                plotOptions: {
                                    radialBar: {
                                        ...
                                        dataLabels: {
                                            showOn: "always",
                                            name: { show: !0, fontSize: "12px", fontWeight: "700", offsetY: -5, color: KTUtil.getCssVariableValue("--kt-gray-500") },
                                            value: {
                                        ...
                                        track: { background: KTUtil.getCssVariableValue("--kt-gray-300"), strokeWidth: "100%" },
                                    },
                                },
            ...
            (function () {
                ...
                if (e) {
                    ...
                    new ApexCharts(e, {
                        ...
                        colors: [r],
                        markers: { colors: [r], strokeColor: [o], strokeWidth: 3 },
                    }).render();
                }
            })(),
            (function () {
            ...
            (s = document.querySelector("#kt_user_follow_button")) &&
                        ...
                        s.classList.contains("btn-success")
                            ? setTimeout(function () {
                                  s.removeAttribute("data-kt-indicator"),
                                      ...
                                      s.querySelector(".svg-icon").classList.add("d-none"),
                                      (s.querySelector(".indicator-label").innerHTML = "Follow"),
                                      (s.disabled = !1);
                              }, 1500)
                            : setTimeout(function () {
                                  s.removeAttribute("data-kt-indicator"),
                                      ...
                                      s.querySelector(".svg-icon").classList.remove("d-none"),
                                      (s.querySelector(".indicator-label").innerHTML = "Following"),
                                      (s.disabled = !1);
                              }, 1e3);
                }),
            (function () {
                if ("undefined" != typeof FullCalendar && document.querySelector("#kt_calendar_widget_1")) {
                    ...
                    new FullCalendar.Calendar(s, {
                        ...
                        events: [
                            ...
                            { title: "Conference", start: a, end: r, description: "Lorem ipsum dolor eius mod tempor labore", className: "fc-event-primary" },
